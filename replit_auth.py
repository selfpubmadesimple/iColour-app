...
from models_security import db, User
...
class ReplitOAuth(OAuthConsumerMixin, db.Model):
    ...
    __table_args__ = (UniqueConstraint(
        ...
        'browser_session_key',
        'provider',
        name='uq_replit_user_browser_provider',
    ),)
...
def save_user(user_claims):
    ...
    username = user_claims.get('username', email)
...
def logged_in(blueprint, token):
    jwks_client = jwt.PyJWKClient(blueprint.base_url + "/jwks")
